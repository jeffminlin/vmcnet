"""Functions for computing statistics related to MCMC time series."""
...
def per_chain_autocorr_fast(
    ...
    G /= jnp.expand_dims(normalization_factors.expand, -1)
...
def tau(autocorr_curve: jnp.ndarray) -> jnp.ndarray:
    ...
    monotonic_min_curve = jnp.minimum.accumulate(positive_sums_curve, axis=0)
